...
function Heading() {
  return (
    <>
      <div className='mb-1 mt-5 w-[65%] rounded-lg border border-gray-200 bg-white object-fill p-6 capitalize shadow'>
        ...
        <div className='mx-4 my-4 hidden text-xs font-semibold md:block md:text-sm md:last:font-medium'>
          <table className='table-auto border-collapse border border-black '>
            <thead>
              <tr>
                <td className='border border-black p-2 text-center uppercase'>Belum Dilakukan</td>
                <td className='border border-black p-2 text-center uppercase'>Mulai Dilakukan</td>
                <td className='border border-black p-2 text-center uppercase'>Sering Dilakukan</td>
                <td className='border border-black p-2 text-center uppercase'>Konsisten Dilakukan</td>
              </tr>
            </thead>
            <tbody>
              <tr>
